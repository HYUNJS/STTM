...
def Qwen2Model_forward(
    ...
    for decoder_layer in self.layers:
        if is_prefilling and decoder_layer.self_attn.layer_idx == self.sa_start_layer_idx:
            ...
            tome_features, tome_token_idxs = get_tome_features(video_features, self.sa_prune_ratio, self.sa_tome_ver)
...
def replace_qwen2_with_tome_attn(sa_start_layer_idx=0, sa_prune_ratio=0.50, sa_tome_ver="frame"):
    """
    ...
    """
    print("Replace Qwen2 Flash Attention2 by ToMe Attn")
    ...
    transformers.models.qwen2.modeling_qwen2.Qwen2Model.sa_tome_ver = sa_tome_ver
