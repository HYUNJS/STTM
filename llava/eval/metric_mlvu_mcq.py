...
TASK_CATEGORIES = ["plotQA", 'findNeedle', 'ego', 'count', 'order', 'anomaly_reco', 'topic_reasoning']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gt_filepath", type=str, default="datasets/mlvu/annotations/MLVU_mcq_v2.json")
